...
titanic_train_dummy['SibSp'] = titanic_train['SibSp']
titanic_train_dummy['Parch'] = titanic_train['Parch']
titanic_train_dummy['Name'] = titanic_train['Name']
...
titanic_test_dummy['SibSp'] = titanic_test['SibSp']
titanic_test_dummy['Parch'] = titanic_test['Parch']
...
titanic_test.to_csv("submission_ensemble_dt.csv", columns=['PassengerId','Survived'], index=False)